...
// 🟢 CORRECTED IMPORT LINE: StarIcon is included here
      ...
      <div className="relative flex flex-wrap gap-4 mt-6">
        ...
        <div className="flex flex-wrap gap-4 w-full">
          {dashboardCards.map((card, index) => (
            <div key={index} className="flex items-center justify-between border px-4 py-3 bg-primary/10 border-primary/20 rounded-md max-w-50 w-full">
              ...
              {/* Rendering lucide-react icons from the card object */}
        ...
        {dashboardData.activeShows.map((show) => (
          <div key={show._id} className="w-55 rounded-lg overflow-hidden h-full pb-3 bg-primary/10 border border-primary/20 hover:-translate-y-1 transition duration-300">
            ...
            <div className="flex items-center justify-between px-2">
              ...
              <div className="flex items-center justify-between gap-1 text-sm text-gray-400 mt-1 pr-1">
                {/* 🟢 DIRECTLY RENDERED STAR ICON */}
